...
WSGI_APPLICATION = 'bidlet.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'src/client/'),
)
...
WEBPACK_LOADER = {
	'DEFAULT': {
        'CACHE': not DEBUG,
    	'BUNDLE_DIR_NAME': os.path.join(BASE_DIR, 'src/client/public/'),
